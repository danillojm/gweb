...
public class FormatadorUtils {
	...
	public static String getNumProcessoFormatado(String processo) throws ParseException {
		MaskFormatter mask = new MaskFormatter("#######-##.####.#.##.####");
		mask.setValueContainsLiteralCharacters(false);
		return mask.valueToString(processo);
	...
	/**
	 * Converte uma string de valor para o formato da RV Exemplos: 1500 => 15.00 = R$ 15,00 125000 => 1250.00 = R$ 1.250,00
	 * 
	 * @param strValor
	 * @return String
	 */
	...
	/**
	 * Método utilizado para converter Double para Long levando em consideração o Padrão do Sistema da Aplic. <br>
	 * <B> Exemplo:</B> <br>
	 * - Valor em Double: 3.5(valor salvo na base) - (valor representando R$ 3,50)<br>
	...
	/**
	 * Método utilizado para converter Long para Double levando em consideração o Padrão do Sistema da Aplic. <br>
	 * <B> Exemplo:</B> <br>
	 * - Valor em Double: 3.5(valor salvo na base) - (valor representando R$ 3,50)<br>
	 * - Valor em Long: 350 (valor salvo na base) - (valor representando R$ 3,50)
	 * 
	...
	public static String SimNaoPorExtenso(String sOuN) {
		if (sOuN == null)
			return "Não";
		else if (sOuN.equalsIgnoreCase("sim"))
			return "Sim";
	...
	/**
	 * Método que recebe um String, que deve representar um valor, e retira somente os números convertendo para um Long.
	 * 
	 * @param valorEmReais
	...
	/**
	 * Método que checa a força de uma senha passada por parâmetro e retorna um inteiro -1 quando a senha for muito fraca ou o indice de força da senha. SENHA_MUITO_FRACA (-1) : Quando a senha tem menos de 6 caracteres e não é composta por letras e números.
	 * 
	 * @param senha
	 * @return
	 */
	...
	public static String getDoubleFormatado(Double valor, int qtdDecimais) {
		...
		DecimalFormat aproximador = new DecimalFormat("##0." + arredondaCampo("", qtdDecimais, "0"), new DecimalFormatSymbols(new Locale("PT", "BR")));
	...
	/**
	 * Retira acentos, caracteres especiais e troca os espações por "_"
	 * 
	 * @return
	 */
	public static String limpaString(String valor) {

		valor = substituiAcento(valor);
	 ...
	 * @return
	 */
	public static String substituiAcento(String valor) {

		valor = valor.replaceAll("[ãâáà]", "a");
		valor = valor.replaceAll("[ÁÀÂÃÄ]", "A");
		valor = valor.replaceAll("[éêèë]", "e");
		valor = valor.replaceAll("[ÉÊÈË]", "E");
		valor = valor.replaceAll("[îíìï]", "i");
		valor = valor.replaceAll("[ÎÍÌÏ]", "I");
		valor = valor.replaceAll("[õôóòö]", "o");
		valor = valor.replaceAll("[ÕÔÓÒÖ]", "O");
		...
		valor = valor.replaceAll("[ñ]", "n");
		valor = valor.replaceAll("[" + ((char) 186) + "]", "o");
		valor = valor.replaceAll("[" + ((char) 170) + "]", "a");
		valor = valor.replaceAll("[" + ((char) 180) + ((char) 96) + "]", "" + ((char) 39));
